...
export const eamilTemplate = (email) => {
  const token = jwt.sign({ email: email }, "finalprojectsecret");
  return `
        <!--
...
<style type="text/css">
@media (max-width: 480px) {
.t29,.t34{mso-line-height-alt:0px!important;line-height:0!important;display:none!important}.t30{padding-top:43px!important;border:0!important;border-radius:0!important}
}
</style>
<!--[if !mso]>-->
...
<table class="t33" role="presentation" cellpadding="0" cellspacing="0" style="Margin-left:auto;Margin-right:auto;"><tr><td width="400" class="t32" style="width:400px;">
<table class="t31" role="presentation" cellpadding="0" cellspacing="0" width="100%" style="width:100%;"><tr><td class="t30" style="border:1px solid #CECECE;overflow:hidden;background-color:#FFFFFF;padding:50px 40px 40px 40px;border-radius:20px 20px 20px 20px;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="width:100% !important;"><tr><td align="center">
